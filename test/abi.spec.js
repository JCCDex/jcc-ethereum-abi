    ...
    describe("test encode & decode", function () {
      ...
      it("test Tansfer event", function () {
        ...
        expect(decodedLogs).to.deep.equal([
          {
            ...
            topics: ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef", "0x0000000000000000000000000f4e07ce7a30d623c8d8bcd947be9fe85db53b56", "0x000000000000000000000000b74768b8b190b0728c7943b1d5f935ffe3f471b1"],
            events: [
              { name: "_from", type: "address", value: "0x0f4e07ce7a30d623c8d8bcd947be9fe85db53b56" },
        ...
        decoded = EthereumABI.decodeLogs([
          ...
          {
            address: "0x37304b0ab297f13f5520c523102797121182fb5b",
            topics: ["0xd0a6f018d0e9629a13bfeb9c60fd1bd8422531c157615dd2b75f0416f9255d98", "0x000000000000000000000000352e48eac00d833b09953397788f4030b6d12b06"],
            event_name: "LogBalanceChange",
            log_index: 142,
          ...
          {
            address: "0x37304b0ab297f13f5520c523102797121182fb5b",
            topics: ["0xd5db3fe23370479a78dc47612ce8be2c8c0ae30d3f255129af35fe3f852b9656", "0x000000000000000000000000f51920ab64b5e5cf1bd06ed53899ad85eadc8c2a", "0x000000000000000000000000352e48eac00d833b09953397788f4030b6d12b06", "0x168f423f0d2ab06628261b7c4c6c260b1a7cbd585791f93b8e5e3649ff29320c"],
            event_name: "LogTrade",
            log_index: 143,
      ...
      it("test transfer event address length", function () {
        const logs = [
          {
            event_name: "",
            data: "0x00000000000000000000000000000000000000000000017aedbc9d648c780000",
