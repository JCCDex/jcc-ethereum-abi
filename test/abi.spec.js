...
describe("test abi", function () {
  ...
  describe("test erc20 abi", function () {
    ...
    describe("test encode & decode", function () {
      ...
      var myContract = new web3.eth.Contract(erc20ABI.default, '0x52bc44d5378309ee2abf1539bf71de1b7d7be3b5', {
        from: '0x1234567890123456789012345678901234567891', // default from address
        gasPrice: '20000000000' // default gas price in wei, 20 gwei in this case
      });
      const inst = new EtherABI(myContract);
      before(function () {
        EtherABI.addABI(erc20ABI.default);
      });

      after(function () {
        EtherABI.removeABI(erc20ABI.default);
      });
